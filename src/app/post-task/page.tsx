...
const StepOne = dynamic(() => import("./_components/StepOne"), { ssr: false });
const StepTwo = dynamic(() => import("./_components/StepTwo"), { ssr: false });
...
const Summary = dynamic(() => import("./_components/Summary"), { ssr: false });
